...
const NewCourceCard = ({
  ...
  title?: string;
  set_cource_items?: any;
  style?: React.CSSProperties;
}) => {
  const [is_open, set_is_open] = React.useState(true);
  return (
    <div style={{ ...style,overflow:"hidden",border:"1px solid black" }} className="custom_card">
      <div
        onClick={(e) => {
          e.stopPropagation();
          set_is_open((pre) => !pre);
      ...
      >
        <h4 style={{ padding: "0px 0px", fontSize: 14, fontWeight: 600 }}>
          {title}
        </h4>
        <div
          style={{
        ...
        >
          ...
          >
            <motion.img
              ...
              src={ArrowTriangle as unknown as string}
              width={8}
              height={8}
