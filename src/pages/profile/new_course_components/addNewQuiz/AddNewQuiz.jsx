...
const AddNewQuiz = ({ setShowQuizModal, showQuizModal }) => {
  const [quizOrder, setQuizOrder] = useState(3);
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col border-b border-gray-300">
        ...
        <div className="px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div
              className={`bg-gray-200 border border-gray-300 rounded-full size-[20px] text-gray-700 flex items-center justify-center text-sm`}
            >
              2
            </div>
          </div>
      ...
      {/* main */}
      <form className="px-8 py-8 bg-[#eff1f7] flex-grow h-full overflow-y-scroll scrollbar-thin space-y-8">
        {quizOrder === 1 ? (
          <QuizInfo />
        ) : quizOrder === 2 ? (
          <AddQuestion formik={formik} />
        ) : quizOrder === 3 ? (
