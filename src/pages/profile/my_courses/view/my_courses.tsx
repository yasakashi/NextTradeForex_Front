...
interface CourseCardProps {
  ...
  lessencount?: number;
  coursetgas?: string;
  updater: (id: string | number) => void;
}

export const CourceCard = ({ props }: { props: CourseCardProps }) => {
...
export const CourseImgTag = ({
  ...
  return (
    <motion.img
      ...
      src={img ? img : cover ? url : (place as unknown as string)}
      alt=""
