  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="flex items-center mr-2 bg-[#1976d2] text-white rounded-lg shadow-sm cursor-pointer px-2 py-1 hover:shadow-none"
      >
        <TiPlus size={20} />
        <h5 className="font-semibold text-sm mr-2">New</h5>
      </Link>
