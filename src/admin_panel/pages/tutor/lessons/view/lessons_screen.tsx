...
const LessonsScreen = () => {
  ...
  return (
    <div className="flex flex-col px-8 py-8">
      ...
      <MAterialTable
        rows={[{ title: "Monetary Authority of Singapore — Pending" }] as any[]}
        columns={[
          {
            header: "Title",
            accessorKey: "title",
          ...
          },
          {
            ...
            Cell: ({ row }) => {
              return <p className="text-blue-800 cursor-pointer" style={{color: "#2271b1",}}>Add Audio</p>;
            },
          },
          {
            header: "Author",
            ...
            Cell: ({ row }) => {
              return <p className="text-blue-800 cursor-pointer" style={{color: "#2271b1",}}>NextBit</p>;
            },
          },
          {
            header: "Date",
