...
function CommodityList() {
  ...
  const deleteData = async (categoryid) => {
    try {
      dispatch(toggle_loading(true));
      await http_instanse_level_2.post('/api/marketpuls/deletecomodityitem', {
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({
  ...
  return (
    <div className="flex flex-col px-8 py-8">
      ...
      <MAterialTable
        rows={data} // Set rows to fetched data
        columns={[
          {
            header: 'Title',
                ...
                <div className="flex items-center">
                  ...
                  <BorderedButtonPrimary
                    ...
                    onClick={() => {
                      ...
                      navigate(
                        `/admin-panel/lessons/market-pulse/forex/${row.original.id}`
                      );
                    }}
